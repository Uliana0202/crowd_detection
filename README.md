...
## Описание проекта
### Fine-tuning
Для задачи детекции была выбрана модель YOLO11. Также данная модель была дообучена на датасете [CrowdHuman-with-YoloLabels]([https://www.kaggle.com/datasets/menhari/crowd-human-crowd-detection](https://www.kaggle.com/datasets/haminhtien99/crowdhuman-with-yololabels)).  
...
Режим SAHI:  
Плюсы: более высокая уверенность детекции, мелкие объекты детектируются лучше (особенно заметно на фоне).
